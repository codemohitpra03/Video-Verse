...
const WatchPage = () => {
	...
	return !videoDetails ? null : (
		<div className="flex justify-center items-start flex-row m-2 mx-4 w-full">
			...
			<div className=" flex flex-col justify-center mx-2 w-[800px]">
				...
				{/* discription */}
				<div className="flex flex-col rounded-lg bg-slate-100 dark:bg-slate-700/60 dark:hover:bg-slate-700/90 hover:bg-slate-300 dark:text-slate-50/80 p-2 mt-3 w-[800px]">
					<div className=" flex items-center ">
						<span>
							{abbreviateNumber(
